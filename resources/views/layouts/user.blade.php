...
<head>
	...
	<!-- title -->
	<title>Khori Tegeh Dekorasi</title>

	<!-- favicon -->
	<link rel="shortcut icon" type="image/png" href="{{ URL::asset('admintemplate/img/favicon.ico') }}">
	<!-- google font -->
            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12 text-center">
                    <div class="main-menu-wrap">
                        ...
                        <nav class="main-menu">
                            <ul>
                                <li class="current-list-item"><a href="{{ route('user.home') }}">Beranda</a>
                                    {{-- <ul class="sub-menu">
                                ...
                                {{-- <li><a href="contact.html">Contact</a></li> --}}
                                <li><a href="{{ route('user.shop.index') }}">Pemesanan</a>
                                    {{-- <ul class="sub-menu">
                                        <li><a href="shop.html">Shop</a></li>
                                        <li><a href="checkout.html">Check Out</a></li>
                                ...
                                <li>
                                    <div class="header-icons">
                                        ...
                                        <a class="shopping-cart" href="{{ route('user.notification') }}"><i class="fas fa-bell"> ({{ $notification = Auth::guard('web')->user()->notifications->where('read_at', null)->count(); }}) </i></a>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="footer-box get-in-touch">
                        ...
                        <ul>
                            <li>Gianyar, Bali.</li>
                            <li>khoritegehdekorasi@gmail.com</li>
                            <li>+6281 90731 4656</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <p>Copyrights &copy; 2023 - Khori Tegeh Dekorasi  All Rights Reserved.
                    </p>
                </div>

...
<head>
    ...
    <title>Superadmin | Khori Tegeh</title>
    @livewireStyles
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
    ...
    <style>
        .btn{
            padding: 0.375rem 0.5rem 0.375rem 3rem!important;
        }
    </style>
            ...
            <div class="nano-content">
                <ul>
                    <div class="logo"><a href="index.html">
                            <!-- <img src="assets/images/logo.png" alt="" /> --><span>Khori Tegeh</span></a></div>
                    ...
                    <li><a href="{{ route('admin.negotiation.index') }}"><i class="ti-receipt"></i> Negosiasi </a>
                    </li>
                    </li>

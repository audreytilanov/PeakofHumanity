                    ...
                    <table class="total-table">
                        ...
                        <tbody>
                            ...
                            <tr class="total-data">
                                ...
                                <td>{{ $transaction->tgl_pemasangan }}</td>
                            </tr>
                            <tr class="total-data">
                                <td><strong>Tanggal Pembongkaran: </strong></td>
                                <td>{{ $transaction->tgl_pembongkaran }}</td>
                            </tr>
                            {{-- <tr class="total-data">
                            ...
                            <tr class="total-data">
                                ...
                                <td>Rp. {{ number_format($transaction->shipping_cost) ?? 'Menunggu admin menentukan harga.' }}</td>
                            </tr>
                            <tr class="total-data">
                                <td><strong>Grand Total: </strong></td>
                                <td>Rp. {{ number_format($transaction->sub_total + $transaction->shipping_cost) }}</td>
                            </tr>
                            <tr class="total-data">
                                <td><strong>Proof of Payment: (Image)</strong></td>
                                @if(!empty($transaction->shipping_cost))
                                ...
                                @else
                                <td>
                                    Belum bisa membayar, Menunggu admin menentukan pengiriman.
                                </td>
                                @endif
                            </tr>
                        </tbody>

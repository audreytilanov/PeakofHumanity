                ...
                <div class="col-md-12 col-lg-7 offset-lg-1 offset-xl-0">
                    <div class="hero-text">
                        <div class="hero-text-tablecell">
                            <p class="subtitle">Khori Tegeh Dekorasi</p>
                            <h1>Pemesanan Dekorasi Online</h1>
                            <div class="hero-btns">
                                <a href="shop.html" class="boxed-btn">Pemesanan</a>
...
<div class="testimonail-section mt-150 mb-150">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 offset-lg-2 text-center">
                <div class="section-title">	
                    <h3><span class="orange-text">Customer</span> Testimonial</h3>
                </div>
            </div>
        </div>
        <div class="row">

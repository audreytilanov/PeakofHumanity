...
use App\Http\Controllers\User\UserNegotiationController;
...
Route::get('/', [UserLoginController::class, 'redirectLogin'])->name('redirectLogin');
...
Route::name('user.')->group(function(){
    ...
    Route::middleware(['auth:web', 'IsUserVerified', 'pvb'])->group(function(){
        ...
        // USER NEGOTIATION
        Route::prefix('negotiation')->name('negotiation.')->group(function(){
            Route::get('/{id}',[UserNegotiationController::class, 'index'])->name('index');
            Route::post('/post',[UserNegotiationController::class, 'store'])->name('store');
        });
...
Route::prefix('superadmin')->name('admin.')->group(function(){
    ...
    Route::middleware(['auth:admin', 'pvb'])->group(function(){
        ...
        Route::prefix('negotiation')->name('negotiation.')->group(function(){
            ...
            Route::get('/{id}',[NegotiationController::class, 'detail'])->name('detail');
            Route::get('/create',[NegotiationController::class, 'create'])->name('create');
            Route::post('/create',[NegotiationController::class, 'store'])->name('store');
            Route::get('/edit/{id}',[NegotiationController::class, 'edit'])->name('edit');
            Route::post('/edit/{id}',[NegotiationController::class, 'update'])->name('update');
        });
